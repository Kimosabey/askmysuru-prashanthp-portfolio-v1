            ...
            >
              <div className="relative aspect-video overflow-hidden rounded-sm mb-6">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  {film.tags.map(tag => (
                    <span key={tag} className="font-label text-[8px] uppercase tracking-widest bg-black/60 backdrop-blur-md px-2 py-1 text-white border border-white/10">{tag}</span>
                  ))}
                </div>
              </div>
