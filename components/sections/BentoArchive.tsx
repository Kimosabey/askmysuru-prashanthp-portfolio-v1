...
export default function BentoArchive() {
  return (
    <section className="py-24 px-6 md:px-12 bg-background max-w-[1600px] mx-auto" id="archive">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:auto-rows-[450px]">
        {MOCK_PROJECTS.slice(0, 4).map((project, index) => (
          <motion.div
            ...
            className={`relative group overflow-hidden border border-border hover:border-accent transition-colors duration-500 bg-surface ${
